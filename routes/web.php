...
Route::prefix('admin')->middleware(['auth', 'admin'])->group(function () {
    ...
    // НОВЫЕ МАРШРУТЫ ДЛЯ НАСТРОЕК СОБЫТИЙ
    Route::get('events', [EventSettingsController::class, 'index'])->name('admin.events.index');
    Route::post('events/update', [EventSettingsController::class, 'update'])->name('admin.events.update');
});
...
Route::get('/useragreement', [UserController::class, 'useragreement'])->name('useragreement');
